...
document.getElementById("Sketch_to_be_drawn").innerHTML = "Sketch_to_be_drawn" + random_sketch;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
function check_sketch() {
    ...
    document.getElementById("timer_counter").innerHTML = "timer_counter:" + timer_counter;
